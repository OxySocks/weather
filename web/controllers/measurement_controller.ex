defmodule Weather.MeasurementController do
  use Weather.Web, :controller

  alias Weather.Measurement

  plug :scrub_params, "measurement" when action in [:create, :update]
  ...
  def create(conn, %{"measurement" => measurement_params}) do
    ...
    case Repo.insert(changeset) do
      ...
      {:error, changeset} ->
        ...
        |> render(Weather.ChangesetView, "error.json", changeset: changeset)
    end
  end
